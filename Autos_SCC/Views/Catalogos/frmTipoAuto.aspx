            ...
            <center>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:Label ID="lblTitulo" runat="server" CssClass="TituloEtiquetas" Text="Catálogo de Tipos de Auto"></asp:Label>
                    </td>
                    <td>
                        <br />
                        <br />
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td style="height: 30px;" align="right">
                                                <asp:Label ID="lblMarca" runat="server" Font-Bold="True" Text="Marca:" CssClass="EtiquetaSimple" />
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlMarca" runat="server" Width="95%" CssClass="ComboSimple">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <td width="80%">
                        <asp:Panel ID="pnlCatalogo" runat="server" ScrollBars="Auto" Width="600px" Height="500px">
                            <asp:GridView ID="gvCatalogo" runat="server" AutoGenerateColumns="false" RowStyle-VerticalAlign="Top"
                                ...
                                OnRowDataBound="gvCatalogo_RowDataBound" OnSelectedIndexChanged="gvCatalogo1_SelectedIndexChanged">
                                <Columns>
