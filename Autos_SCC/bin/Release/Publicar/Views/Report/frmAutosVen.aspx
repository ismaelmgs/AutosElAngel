<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmAutosVen.aspx.cs" UICulture="es" Culture="es-MX" Inherits="Autos_SCC.Views.Report.frmAutosVen" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <asp:ImageButton ID="imbFechaFinal" runat="server" ImageUrl="~/Images/Botones/Calendar.ico" Width="24px" Height="24px" style="margin-bottom: -15px;" />
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="gvReporte" runat="server" AutoGenerateColumns="false" DataKeyNames="fi_Id"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="UsuarioEntregoAuto" HeaderText="Usuario Entregó" />
