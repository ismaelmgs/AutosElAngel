...
namespace Autos_SCC.Objetos
{
    ...
    public class EstatusAuto : BaseObjeto
    {
        private int _iId = -1;
        ...
        [Required(AllowEmptyStrings = false, ErrorMessage = "El campo Estatus es obligatorio")]
        [Display(Name = "Estatus", AutoGenerateField = true)]
