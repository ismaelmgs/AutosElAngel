...
namespace Autos_SCC.Objetos
{
    ...
    public class Parametro : BaseObjeto
    {
        private int _iId = -1;
        ...
        [Required(AllowEmptyStrings = false, ErrorMessage = "El valor del parametro es obligatorio")]
        [Display(Name = "Valor", AutoGenerateField = true)]
